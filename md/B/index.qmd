...
<center>![](zk/__zk01.png)

: Imagens de [David B. Clear](https://writingcooperative.com/zettelkasten-how-one-german-scholar-was-so-freakishly-productive-997e4e0ca125).
</center>
...
- [Scrivener](https://www.literatureandlatte.com/scrivener/overview) - processador de texto mais avançado para acadêmicos.
- [Obsidian](https://obsidian.md/) - software de anotações popular, com gráfico de relações e sistema de plugins para novas funções e recursos.
- [Zettlr](https://www.zettlr.com/) - software de anotações gratuito e open-source.
- [Notion](https://www.notion.so/) - software de anotações que pode ser utilizado gratuitamente.
...
- [Visual Studio Code](https://code.visualstudio.com/) com [Github Co-Pilot](https://copilot.github.com/) e [Quarto Extension for Visual Studio Code](https://quarto.org/docs/using-quarto-with-vscode.html)
- [RStudio](https://rstudio.com/), [RStudio Cloud](https://rstudio.cloud/), [RStudio Server](https://rstudio.com/products/rstudio-server/), [RStudio Package Manager](https://rstudio.com/products/package-manager/)
